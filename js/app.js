...
.service('$cbmSources', function () {
    ...
    var list = [
        ...
        {path: 'bombeiro-indo-embora', name: 'Bombeiro indo embora no incêndio'},
        ...
        {path: 'gasolina', name: 'Jogando gasolina na fogueira'},
        {path: 'gorila-react'},
        {path: 'gorila-react-2'},
        {path: 'homer-escondendo', name: 'Homer Simpsons escondendo na moita'},
        {path: 'incendio', name: 'Incêndio - Salvar apenas um'},
        {path: 'lendo-livro'},
